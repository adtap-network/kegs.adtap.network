...
class CategoryOptionsCols extends Columns implements ColumnsInterface {
    constructor() {
        super();
        ...
        this.guids = ['option_id'];
        this.strings = ['option_field','option_type','option_label','option_value'];
        this.dates = [];
        this.booleans = [];
...
export default CategoryOptionsCols;