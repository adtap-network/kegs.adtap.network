import CommonAdapter from '../adapter'
import CommonDatasourceInterface from '../../common/interfaces/datasource';
import CommonModelInterface from '../../common/interfaces/model';
import CommonAdapterInterface from '../../common/interfaces/adapter';
import mysql, { Pool, PoolConnection, RowDataPacket, ResultSetHeader } from 'mysql2/promise';

class MysqlAdapter extends CommonAdapter implements CommonAdapterInterface {

    pool: Pool;

    constructor(datasource: CommonDatasourceInterface, model: CommonModelInterface) {
