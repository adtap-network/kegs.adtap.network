...
export default class BookBean extends Base {
    ...
    addAsk(a: {[key: string]: any}) { this.asks.push(a); return this.countAsks(); }

	addBid(a: {[key: string]: any}) { this.bids.push(a); return this.countBids(); }
	...
	setAsks(a: {[key: string]: any}[]) { this.asks = a; return this.countAsks(); }

	setBids(a: {[key: string]: any}[]) { this.bids = a; return this.countBids(); }

	compareAsks(a: {[key: string]: any}, b: {[key: string]:any}) { return a.price - b.price; }

	compareBids(a: {[key: string]: any}, b: {[key: string]:any}) { return b.price - a.price; }
