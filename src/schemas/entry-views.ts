...
export const EntryViewsSchema = Type.Object(
  {
    view_id: Type.String({ format: 'uuid', maxLength: 36 }),
    view_entry: Type.String({ format: 'uuid', maxLength: 36 }),
  ...
  { $id: 'EntryViews', additionalProperties: false }
)
export type EntryViewsType = Static<typeof EntryViewsSchema>